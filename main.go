...
func NewChatApp() *ChatApp {
	...
	toolbar := widget.NewToolbar(
		...
		widget.NewToolbarAction(icns.Icon("dalle3"), func() {
			dalle3.DalleWindow(a, w)
		}),
